...
CREATE TABLE `mmall_cart` (
  ...
  CONSTRAINT `mmall_cart_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `mmall_product` (`id`)
...
CREATE TABLE `mmall_category` (
  ...
  `parent_id` varchar(32) DEFAULT NULL COMMENT '父类别id 当id=0时说明是根节点，一级类别',
...
insert  into `mmall_category`(`id`,`parent_id`,`name`,`status`,`sort_order`,`create_time`,`update_time`) values
                                                                                                                ('123','23123','12312',1,123123,'2019-06-23 17:36:21','2019-06-03 17:36:15'),
                                                                                                                ('1234','0','name',1,1,'2019-06-22 12:44:22','2019-06-22 12:44:22');

/*Table structure for table `mmall_guestbook` */
...
CREATE TABLE `mmall_guestbook` (
  ...
  KEY `user_id` (`user_id`),
  KEY `product_id` (`product_id`),
  CONSTRAINT `mmall_guestbook_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mmall_user` (`id`),
  CONSTRAINT `mmall_guestbook_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `mmall_product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='留言表';

/*Data for the table `mmall_guestbook` */
...
CREATE TABLE `mmall_order_item` (
  ...
  CONSTRAINT `mmall_order_item_ibfk_3` FOREIGN KEY (`product_id`) REFERENCES `mmall_product` (`id`)
...
CREATE TABLE `mmall_product` (
  ...
  `category_id` varchar(32) NOT NULL COMMENT '分类id 对应mmall_categoryb表的主键',
  ...
  CONSTRAINT `mmall_product_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `mmall_category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='产品表';

/*Data for the table `mmall_product` */

insert  into `mmall_product`(`id`,`category_id`,`name`,`subtitle`,`main_image`,`sub_images`,`detail`,`price`,`stock`,`status`,`create_time`,`update_time`) values
                                                                                                                                                                  ('123','123','123','123','123',NULL,NULL,123,123,1,'2019-06-23 17:37:17','2019-06-30 17:37:23'),
                                                                                                                                                                  ('1234555','123','123','123','123','123','123',123,123,1,'2019-06-22 13:13:28','2019-06-22 13:13:28');
...
insert  into `mmall_user`(`id`,`username`,`password`,`email`,`phone`,`nickname`,`question`,`answer`,`role`,`create_time`,`update_time`,`gender`,`age`) values
                                                                                                                                                              ('123','1111','123123','123123','123123','123123123','123123','123123',123123,'2019-06-22 17:34:56','2019-08-31 17:34:59',1,NULL);
